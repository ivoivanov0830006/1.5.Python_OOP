...
You are the F1 manager of the two biggest teams in F1, "Red Bull" and "Mercedes". Your task is
to create a program that calculates the revenue after every race for both teams. Your app should
have the following structure and functionality.
1. Class FormulaTeam
...
of formula team, and it should not be able to be instantiated.
    ...
    The class should have the following attribute:
        •	budget: int
            ...
            o	If the budget is less than 1 000 000, raise ValueError with the message: "F1 is an
            expensive sport, find more sponsors!"
    Methods
    * __init__(budget: int)
...
In the red_bull_team.py, the class RedBullTeam should be implemented.
    ...
    * calculate_revenue_after_race(race_pos: int)
        ...
        •	After that, add the result to the team's budget and return the following message:
        "The revenue after thе race is { revenue }$. Current budget { current budget }$"
Note: Each sponsor gives the money for the best position only. If you are 1st and the sponsor gives
money for 1st and 2nd positions, you get the money only for the 1st position!
...
In the mercedes.py, the class MercedesTeam should be implemented.
    ...
    * calculate_revenue_after_race(race_pos: int)
        ...
        on the position in the race and subtract the expenses
        •	After that, add the result to the team's budget and return the following message:
        "The revenue after the race is { revenue }$. Current budget { current budget }$"
Note: Each sponsor gives the money for the best position only. If you are 1st and the sponsor gives money
for 1st and 2nd positions, you get the money only for the 1st position!
4. Class F1SeasonApp
In the f1_season_app.py file, the class F1SeasonApp should be implemented. It will contain all the
functionality of the project.
    ...
    * register_team_for_season(team_name: str, budget: int)
        ...
        •	If a team name is valid, register the team with the corresponding name and return the
        following message:
...
Red Bull: The revenue after the race is 1270000$. Current budget 3270000$.
Mercedes: The revenue after the race is -150000$. Current budget 2350000$.
Red Bull is ahead at the Nurburgring race.
Red Bull: The revenue after the race is -240000$. Current budget 3030000$.
Mercedes: The revenue after the race is 900000$. Current budget 3250000$.
